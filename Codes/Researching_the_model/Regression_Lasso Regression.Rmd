...
---
title: "Regression_Lasso Regression"
output:
  html_document:
    toc: true
---
...
The above output shows that RMSE, one of the two evaluation metrics, is 80.82 for train data and 84.69  for test data. On the other hand, R-squared value is around 25 percent for both train and test data, which indicates bad performance.
...
The optimal lambda value comes out to be 7.943282 and will be used to build the ridge regression model
...
80.82 for train data and 84.69  for test data.
...
Once we have the optimal lambda value, we train the lasso model in the first line of code below.
...
It works by penalizing the model using both the 1l2-norm1 and the 1l1-norm1. 

The model can be easily built using the caret package, which automatically selects the optimal value of parameters alpha and lambda.


- The first line of code creates the training control object train_cont which specifies how the repeated cross validation will take place. 

- The second line builds the elastic regression model in which a range of possible alpha and lambda values are tested and their optimum value is selected. The argument tuneLength specifies that 10 different combinations of values for alpha and lambda are to be tested.
...
Once we have trained the model, we use it to generate the predictions and print the evaluation results for both the training and test datasets
...
The above output shows that the RMSE and R-squared values for the elastic net regression model on the training data are and  percent, respectively. 

The results for these metrics on the test data are  and 86 , respectively.

Conclusion

The performance of the models is summarized below:

- Linear Regression Model: Test set RMSE of  and R-square of  percent.

- Ridge Regression Model: Test set RMSE of and R-square of  percent.

- Lasso Regression Model: Test set RMSE of  and R-square of percent.

- ElasticNet Regression Model: Test set RMSE of  and R-square of  percent.
